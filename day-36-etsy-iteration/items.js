...
//   itemMaterials = item.materials;
  ...
  //console.log('These are the currency codes:', currencyCode);
  //console.log(itemCount + '.  ' + 'These are the Who made:', whoMade);
  //console.log('This is the item Price:', itemPrice);
  //console.log('This is the item Materials:', itemMaterials);
//}
...
//  item.price
// =======================================================================
function avgItemPrice() {
  var itemCount = 0;
  var itemTotal = 0;
  var avg = 0;
  //console.log('In avgItemPrice ');
  for (var item of items) {
    itemCount += 1;
  ...
  avg = (itemTotal / itemCount);
  avg = Math.round(avg * 100) / 100;
  //console.log('This is the rounded avg item price:', avg);
...
//  item.price >= 14.00 <= 18.00
// =======================================================================
function itemsBetween() {
  var itemsList = [];
  var itemCount = 0;
  for (var item of items) {
    ...
    if (item.price >= 14.00 && item.price <= 18.00)  {
      //console.log('Item name:', item.title + '      ' + 'Item Price: ' + item.price);
      itemsList.push(item.price);
    }
  }
  //console.log('This is the list of items: ', itemsList);
  return itemsList;
  }
...
function itemsGBP() {
    ...
    for (var item of items) {
      ...
      if (item.currency_code === 'GBP')  {
        //console.log('Item name:', item.title + '      ' + 'Item Price: ' + item.price + '      ' + 'Currency Code: ' + item.currency_code);
        itemsList.push(item.price);
      }
    }
    //console.log('This is the list of items: ', itemsList);
